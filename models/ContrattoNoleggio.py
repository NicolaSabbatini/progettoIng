...
class ContrattoNoleggio(Contratto): 
     
    def __init__(self):
        super().__init__()

    def addRentContract(self, user, auto, start_date, end_date, cauzione, prezzoTot, durataGaranzia, tipoGaranzia, kmMax):
        ...
        self.saveRentContracts()
        return True, "Contratto creato con successo"
    
    def saveRentContracts(self):
